  ...
  return (
    <>
      <Routes>
        ...
        <Route exact path="payment-page" element={<Payment logOut={logOut} complaintID={complaintID} userDetails={{ userName, userContact, userFirstName, userLastName, userEmail }} navigator={navigator} setJobCard={setJobCard} jobCard={jobCardDetails} />}></Route>
        <Route exact path="make-payment" element={<MakePayment logOut={logOut} complaintID={complaintID} userDetails={{ userName, userContact, userFirstName, userLastName, userEmail }} navigator={navigator} jobCard={jobCardDetails} />}></Route>
        ...
        <Route exact path="all-complaints" element={<AllComplaints setComplaintToAssign={setComplaintToAssign} logOut={logOut} allComplaintIDs={allComplaintIDs} allComplaintData={allComplaintData} userDetails={{ userName, userContact, userFirstName, userLastName, userEmail }} navigator={navigator} />}></Route>
        <Route exact path="assign-complaints" element={<AssignComplaints complaintToAssign={complaintToAssign} logOut={logOut} allPlumberIDs={allPlumberIDs} allPlumberData={allPlumberData} userDetails={{ userName, userContact, userFirstName, userLastName, userEmail }} navigator={navigator} />}></Route>
      </Routes>
    </>
  );
}
